...
import { CartesianGrid, LineChart, ResponsiveContainer, XAxis, YAxis, Tooltip, Legend, Line, Label } from 'recharts'
        ...
        <DashBox width="100%" height="100%" p="1rem" overflow="hidden">
            <FlexBetween m="1rem 2.5rem" gap="1rem">
                <Box>
                    ...
                    <Typography variant='h6'>Charted Revenue and Predicted Revenue based on simple Linear Regeression model</Typography>
                </Box>
                <Button onClick={() => setIsPredicted(!isPredicted)} sx={{
